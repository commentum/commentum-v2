-- Migration 029: Real-points Leaderboard Ranking & Infinite Points for Owners

-- ===================================================
-- 1. Redefine get_user_points:
--    - Calculates real_points (pure activity without role bonus)
--    - Flags is_infinite = true & display_points = '∞' for owner and app_owner
-- ===================================================
...
-- ===================================================
-- 2. Redefine get_points_leaderboard:
--    - Ranked strictly by real_points (genuine community activity)
--    - Includes role_bonus, is_infinite flag
-- ===================================================
