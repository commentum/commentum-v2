    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          required: false,
          choices: [
            { name: 'decorations_enabled (true/false)', value: 'decorations_enabled' },
            { name: 'points_enabled (true/false)', value: 'points_enabled' },
            { name: 'points_leaderboard_enabled (true/false)', value: 'points_leaderboard_enabled' },
            { name: 'announcements_enabled (true/false)', value: 'announcements_enabled' },
            { name: 'voting_enabled (true/false)', value: 'voting_enabled' },
            { name: 'reporting_enabled (true/false)', value: 'reporting_enabled' },
            { name: 'system_enabled (true/false)', value: 'system_enabled' },
            { name: 'fcm_notifications_enabled (true/false)', value: 'fcm_notifications_enabled' },
            { name: 'discord_notifications_enabled (true/false)', value: 'discord_notifications_enabled' },
            { name: 'points_per_comment (number)', value: 'points_per_comment' },
            { name: 'points_per_reply (number)', value: 'points_per_reply' },
            { name: 'points_per_upvote_received (number)', value: 'points_per_upvote_received' },
            { name: 'points_per_vote_cast (number)', value: 'points_per_vote_cast' },
            { name: 'points_per_pinned (number)', value: 'points_per_pinned' },
            { name: 'max_comment_length (number)', value: 'max_comment_length' },
            { name: 'rate_limit_comments_per_hour (number)', value: 'rate_limit_comments_per_hour' },
            { name: 'banned_keywords (JSON array)', value: 'banned_keywords' },
            { name: 'owner_users (JSON array)', value: 'owner_users' },
            { name: 'app_owner_users (JSON array)', value: 'app_owner_users' },
            { name: 'super_admin_users (JSON array)', value: 'super_admin_users' },
            { name: 'admin_users (JSON array)', value: 'admin_users' },
            { name: 'moderator_users (JSON array)', value: 'moderator_users' },
            { name: 'discord_notification_types (JSON array)', value: 'discord_notification_types' },
            { name: 'fcm_notification_types (JSON array)', value: 'fcm_notification_types' }
          ]
        },
        {
          name: 'value',
